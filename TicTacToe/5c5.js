...
function init(){
    ...
    for(let i =0 ; i < 25 ; i++){
        ...
        //adding square number such that we can check win condition
...
//pattern = [0,1,2]
 ...
 let val5 =allSquares[pattern[4]];

if(val1.firstChild && val2.firstChild && val3.firstChild && val4.firstChild && val5.firstChild){
    if (val1.innerText == val2.innerText && val2.innerText == val3.innerText && val3.innerText == val4.innerText && val4.innerText == val5.innerText ){
        ...
        allSquares[pattern[4]].style.backgroundColor = 'green';
